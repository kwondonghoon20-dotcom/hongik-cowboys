...
export const players = [
  // 1학년 26학번
  { id: 'p1', grade: 1, year: 26, number: 67, numbersBySeason: { 2025: 67 }, name: '김민영', positions: { offense: 'OL', defense: 'DL' }, height: null, weight: null },
  { id: 'p2', grade: 1, year: 26, number: 55, numbersBySeason: { 2025: 55 }, name: '곽정우', positions: { offense: 'OL', defense: 'DL' }, height: null, weight: null },
  { id: 'p3', grade: 1, year: 26, number: 4, numbersBySeason: { 2026: 4 }, name: '김민석', positions: { offense: 'RB', defense: 'LB' }, height: null, weight: null },
  ...
  // 3학년 24학번
  { id: 'p14', grade: 3, year: 24, number: 88, numbersBySeason: { 2025: 88 }, name: '김민규', positions: { offense: 'TE', defense: 'LB' }, height: null, weight: null },
  { id: 'p15', grade: 3, year: 24, number: 72, numbersBySeason: { 2025: 72 }, name: '정윤우', positions: { offense: 'OL', defense: 'LB' }, height: 169, weight: 83 },
  ...
  // 4학년 23학번
  { id: 'p25', grade: 4, year: 23, number: 9, numbersBySeason: { 2025: 9 }, name: '권용욱', positions: { offense: 'QB', defense: 'LB' }, height: 174, weight: 76 },
  ...
  // 4학년 20학번
  { id: 'p30', grade: 4, year: 20, number: 66, numbersBySeason: { 2025: 66 }, name: '송준석', positions: { offense: 'OL', defense: 'DL' }, height: 180, weight: 93 },

  // 4학년 19학번
  { id: 'p31', grade: 4, year: 19, number: 49, numbersBySeason: { 2025: 49 }, name: '김상현', positions: { offense: 'RB', defense: 'LB' }, height: 170, weight: 75 },
  { id: 'p33', grade: 1, year: 26, number: 27, numbersBySeason: { 2026: 27 }, name: '김주형', positions: { offense: 'WR', defense: 'DB' }, height: null, weight: null },
]
...
export const rosterByYear = {
  ...
  2026: [
    'p1', 'p2', 'p3', 'p4', 'p5', 'p6', 'p9', 'p10', 'p11', 'p12', 'p13',
    'p14', 'p17', 'p19', 'p20', 'p22', 'p23', 'p24', 'p25', 'p26', 'p27',
    'p28', 'p29', 'p30', 'p32', 'p33',
  ],
}
